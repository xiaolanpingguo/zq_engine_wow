...
#include "type_container_fun.hpp"
...
public:
    ...
    {
        return tcf::Insert(_elements, handle, obj);
    }

    template<class SPECIFIC_TYPE>
    bool Remove(KEY_TYPE const& handle)
    {
        return tcf::Remove(_elements, handle, (SPECIFIC_TYPE*)nullptr);
    }

    template<class SPECIFIC_TYPE>
    SPECIFIC_TYPE* Find(KEY_TYPE const& handle)
    {
        return tcf::Find(_elements, handle, (SPECIFIC_TYPE*)nullptr);
    }
