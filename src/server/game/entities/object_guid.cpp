...
//}
//
//ObjectGuid ObjectGuid::Global(HighGuid type, ObjectGuid::LowType counter)
//{
//    return ObjectGuid(type, counter);
//}
//
//ObjectGuid ObjectGuid::MapSpecific(HighGuid type, uint32 entry, ObjectGuid::LowType counter)
//{
