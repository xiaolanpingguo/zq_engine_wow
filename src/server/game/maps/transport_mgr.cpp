...
//    //    if (goInfo == nullptr)
//    //    {
//    //         LOG_ERROR << fmt::format("Transport %u has no associated GameObjectTemplate from `gameobject_template` , skipped.", entry);
//    //        continue;
//    //    }
//
//    //    if (goInfo->moTransport.taxiPathId >= sTaxiPathNodesByPath.size())
//    //    {
//    //         LOG_ERROR << fmt::format("Transport %u (name: %s) has an invalid path specified in `gameobject_template`.`data0` (%u) field, skipped.", entry, goInfo->name.c_str(), goInfo->moTransport.taxiPathId);
//    //        continue;
//    //    }
//
...
//    if (!tInfo)
//    {
//         LOG_ERROR << fmt::format("Transport %u will not be loaded, `transport_template` missing", entry);
//        return nullptr;
//    }
//
//    // create transport...
...
//        {
//			LOG_ERROR << fmt::format("Transport %u (name: %s) attempted creation in instance map (id: %u) but it is not an instanced transport!", entry, trans->GetName().c_str(), mapId);
//            delete trans;
//            return nullptr;
//        }
//    }
